...
export function BlockScope({position= [0, 0, 0]}){
...
export function BlockSpiner({position= [0, 0, 0]}){
...
export function Level({ count = 5, types = [ BlockSpiner, BlockAxe, BlockLimbo ],   seed = 0 }) {
